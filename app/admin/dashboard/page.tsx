...
export default async function AdminDashboard() {
  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <div id="whatsapp-settings" className="scroll-mt-32 mt-12 bg-gradient-to-br from-[#25D366]/5 via-white to-emerald-50 rounded-3xl border-2 border-[#25D366]/20 shadow-sm p-6 sm:p-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-black text-gray-900">WhatsApp &amp; Contact Settings</h2>
              <p className="text-sm text-gray-500">Donation ke baad users ko bhejne wala WhatsApp number aur message yahan se direct edit karein</p>
            </div>
          </div>
          <div className="flex items-center gap-2 bg-[#25D366]/10 text-[#25D366] px-3 py-1.5 rounded-full text-xs font-bold flex-shrink-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
            ...
            <div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                <p className="text-[11px] text-gray-400 mb-3">Country code ke saath likhein, bina + ya spaces ke.<br/>Example: <strong>919876543210</strong> = +91 98765 43210</p>
                <input
                  name="whatsappNumber"
                  defaultValue={siteSettings?.whatsappNumber || "919999999999"}
                  required
                  placeholder="e.g. 919876543210"
                  className="w-full p-3.5 rounded-xl border-2 border-gray-200 focus:border-[#25D366] focus:ring-2 focus:ring-[#25D366]/20 focus:outline-none text-sm font-mono transition-all bg-gray-50"
                />
            ...
            <div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                <p className="text-[11px] text-gray-400 mb-3">Yeh message user ke WhatsApp mein automatically type hoga jab woh donation button click karega.</p>
                <textarea
                  name="whatsappMessage"
                  defaultValue={siteSettings?.whatsappMessage || "🙏 Jai Hanuman!\n\nI have completed my donation.\nPlease find my payment screenshot attached.\n\nThank you."}
                  rows={5}
                  className="w-full p-3.5 rounded-xl border-2 border-gray-200 focus:border-[#25D366] focus:ring-2 focus:ring-[#25D366]/20 focus:outline-none text-sm font-mono transition-all bg-gray-50 resize-none"
                />
              </div>
            </div>
