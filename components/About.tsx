...
export default function About({ imageUrl }: { imageUrl?: string }) {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto" id="about" aria-label="About the Temple">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <aside className="grid grid-cols-2 gap-4" aria-label="Temple Details">
            {info.map((item, i) => (
              <motion.div
                key={item.label}
        ...
        >
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-2xl h-[480px] z-10 w-full">
            <Image
              src={imageUrl || "/assets/temple_04.jpg"}
          ...
          {/* Badge */}
          <figcaption className="absolute -bottom-6 -right-6 z-20 bg-white rounded-2xl shadow-xl p-4 border border-orange-100 text-center">
